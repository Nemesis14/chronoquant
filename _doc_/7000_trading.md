...
| 7110 | [7110_run_service.md](7110_run_service.md) | `01_run_service.py` CLI entrypoint | X110 |
| 7120 | [7120_trading_service.md](7120_trading_service.md) | `live/service.py` fő loop | X110 |
| 7130 | [7130_trading_journal.md](7130_trading_journal.md) | `live/journal.py` trading DB contract | X110 |
| 7140 | [7140_trading_exchange.md](7140_trading_exchange.md) | `live/exchange.py` Binance kliens | X110 |
| 7150 | [7150_trading_state_strategy.md](7150_trading_state_strategy.md) | `live/state.py` és `live/strategy.py` döntési mag | X110 |
