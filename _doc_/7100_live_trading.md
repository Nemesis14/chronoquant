...
### [7110_run_service.md](7110_run_service.md)

Foreground CLI indítás, signal handling, live megerősítés.

### [7120_trading_service.md](7120_trading_service.md)

A teljes percenkénti service loop: sync, beolvasás, döntés, végrehajtás, journaling.

### [7130_trading_journal.md](7130_trading_journal.md)

`trading.db` séma, insert/read/export felület.

### [7140_trading_exchange.md](7140_trading_exchange.md)

Binance Futures kliens dry-run és live order placmenttel.

### [7150_trading_state_strategy.md](7150_trading_state_strategy.md)
