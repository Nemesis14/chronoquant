"""Shared DB utilities for _doc_/analysis/ notebooks.

Reuses src/database/store/ functions where possible.
Import from a notebook setup cell: import db_utils as dbu
"""
...
from database.store.duckdb_stats import collect_duckdb_stats_report
