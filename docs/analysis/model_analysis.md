...
### Signal Zones
```
SHORT Signal Zone     â”‚      NEUTRAL Zone      â”‚     LONG Signal Zone
(spread <= -0.0142)   â”‚ (-0.0142 < x < 0.0139)â”‚  (spread >= 0.0139)
     13% accuracy     â”‚      No trade          â”‚      16% accuracy
     1.30x LIFT       â”‚                        â”‚      1.61x LIFT
```

### Recommended Action
- **LONG**: When `spread >= +0.0139` â†’ Signal for price increase
- **SHORT**: When `spread <= -0.0142` â†’ Signal for price decrease
- **NEUTRAL**: When `-0.0142 < spread < +0.0139` â†’ Do not trade
...
- **Training Data:** 2019-11-28 â†’ 2026-01-31
