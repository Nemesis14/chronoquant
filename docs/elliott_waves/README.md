...
| Fájl | Leírás |
|---|---|
| `pivot_spec.md` | Teljes specifikáció: elméleti alap, pivot definíciók, feltételek, scoring, pseudocode |
| `latest_1212_setup.png` | Legfrissebb detektált setup vizualizációja (2026-06-08) |
...
A `pivot_spec.md` három lehetőséget tárgyal (local extrema, ZigZag, hibrid).  
...
| Fájl | Szerepe |
|---|---|
| `src/analysis/elliott_1212.py` | Detektor logika: `detect_pivots()`, `detect_1212()`, scoring, OHLCV loader |
| `scripts/scan_1212.py` | Teljes history scan több TF × threshold kombináción, összesítő táblával |
| `scripts/plot_1212_example.py` | Legfrissebb setup vizualizációja (japángyertya + P0–P4 + confirmation zóna) |
