...
- `docs/engineering/strategy_evaluation.md` — mikor és hogyan futtass backtestet
- `docs/engineering/sampling.md` — adat szétválasztás, holdout policy
- `docs/architecture/sol_trading_strategy.md` — SOL-specifikus stratégia részletek
- `docs/plans/backlog/live_trading_plan.md` — a live trader spec (ugyanezt a logikát hajtja végre valós piacon)
