...
### Phase 1: Core Expansion (8 features â†’ 20 features)
**Timeline: Week 1-2**
...
### Phase 2: Advanced Indicators (20 â†’ 35 features)
**Timeline: Week 3-4**
...
### Phase 3: Optimization & Selection (35 â†’ 15-20 features)
**Timeline: Week 5-6**
...
def retrain_model(
	...
	print(f"âś… Model trained: AUC={auc:.3f}, Accuracy={report['accuracy']:.3f}")
...
```
Input: 35+ features
â”śâ”€ Compute Pearson/Spearman correlation matrix
â”śâ”€ Identify feature pairs with |r| > 0.7
â”śâ”€ Keep one from each pair (highest information value)
â””â”€ Output: ~25-28 features
```

### Step 2: VIF (Multicollinearity) Filter
```
Input: 25-28 features
â”śâ”€ Calculate Variance Inflation Factor for each
â”śâ”€ Remove features with VIF > 5 (high multicollinearity)
â””â”€ Output: ~20-22 features
```

### Step 3: Statistical Significance
```
Input: 20-22 features
â”śâ”€ Test correlation with target (p-value < 0.05)
â”śâ”€ Remove features not significantly related
â””â”€ Output: ~15-18 features
```

### Step 4: Model Performance Backtest
```
Input: 15-18 features
â”śâ”€ Train multiple logistic regression models:
â”‚  â”śâ”€ All 18 features
â”‚  â”śâ”€ Top 15 (by coefficient magnitude)
â”‚  â”śâ”€ Top 12 (by information value)
â”‚  â””â”€ Top 10 (by feature importance)
â”śâ”€ Compare on hold-out test set: AUC, Accuracy, Precision
â””â”€ Output: Final feature set (optimal subset)
```
...
```
â”Śâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
â”‚ 1. Calculate 40+ Extended Features   â”‚  (src/data_pipeline/sync_features.py)
â”‚    Store in FEATURES table           â”‚
â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
               â”‚
â”Śâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â–Ľâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
â”‚ 2. Feature Selection                 â”‚  (src/modeling/feature_selection.py)
â”‚    â”śâ”€ Correlation filter (r<0.7)     â”‚
â”‚    â”śâ”€ VIF filter (VIF<5)             â”‚
â”‚    â”śâ”€ P-value filter (p<0.05)        â”‚
â”‚    â””â”€ Output: 15-18 features         â”‚
â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
               â”‚
â”Śâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â–Ľâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
â”‚ 3. Model Retraining                  â”‚  (src/modeling/model_retrain.py)
â”‚    â”śâ”€ Train logistic regression      â”‚
â”‚    â”śâ”€ Evaluate on test set           â”‚
â”‚    â””â”€ Save model + features.json     â”‚
â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
               â”‚
â”Śâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â–Ľâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
â”‚ 4. Register New Model                â”‚
â”‚    â”śâ”€ Update config/models.json      â”‚
â”‚    â”śâ”€ Set active: true               â”‚
â”‚    â””â”€ predictions.py reads it        â”‚
â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
               â”‚
â”Śâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â–Ľâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
â”‚ 5. Live Predictions                  â”‚
â”‚    â”śâ”€ worker.py calls sync_features  â”‚
â”‚    â”śâ”€ Computes 40+ features          â”‚
â”‚    â”śâ”€ sync_predictions reads model   â”‚
â”‚    â””â”€ Generate signals               â”‚
â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
```
...
```json
{
  "models": {
    "lg_l_rw240_p90_base_sm": {
      ...
      "active": false,
      "paths": {"model_dir": "models/lg_l_rw240_p90_base_sm", "model_file": "model.pkl", "features_file": "features.json"}
    },
    "lg_l_rw240_p90_v2_extended": {
      "target_name": "trg_l_rw_240_prc_09",
      "active": true,
      "paths": {"model_dir": "models/lg_l_rw240_p90_v2_extended", "model_file": "model.pkl", "features_file": "features.json"},
      "description": "Extended features: 35+ indicators, selected 18 features"
    },
    "lg_s_rw240_p90_base_sm": {
      "target_name": "trg_s_rw_240_prc_01",
      "active": false,
      "paths": {"model_dir": "models/lg_s_rw240_p90_base_sm", "model_file": "model.pkl", "features_file": "features.json"}
    },
    "lg_s_rw240_p90_v2_extended": {
      "target_name": "trg_s_rw_240_prc_01",
      "active": true,
      "paths": {"model_dir": "models/lg_s_rw240_p90_v2_extended", "model_file": "model.pkl", "features_file": "features.json"},
      "description": "Extended features: 35+ indicators, selected 18 features"
    }
  }
}
...
- [ ] Save models to models/lg_*_v2_extended/
...
| File | Action | Purpose |
|------|--------|---------|
| src/data_pipeline/sync_features.py | EXTEND | Add 35+ new indicators |
| config/features.json | UPDATE | Define new features |
| config/models.json | UPDATE | Register v2 models |
| src/modeling/feature_selection.py | CREATE | Feature filtering logic |
| src/modeling/model_retrain.py | CREATE | Model training pipeline |
| models/lg_l_rw240_p90_v2_extended/ | CREATE | New model directory |
| models/lg_s_rw240_p90_v2_extended/ | CREATE | New model directory |
| src/analysis/feature_analysis.py | CREATE | Analysis script |
...
- **Total potential variants:** 40+ indicators Ă— 4-5 time windows = **160-200+ features**
...
- Daily samples: 1,440 (24h Ă— 60 min)
...
|----------|--------------|------------|--------|-----------|
| **Comfortable** | p < n/10 | n > 10p | >10:1 | âś“âś“âś“ Stable |
| **Acceptable** | p < n/5 | n > 5p | >5:1 | âś“âś“ Good |
| **Tight** | p < n/2 | n > 2p | >2:1 | âś“ Workable |
| **Risky** | p > n/2 | n < 2p | <2:1 | âś— Unstable |

**For ChronoQuant:**

Scenario A: **144 features, 1 month data (43,200 samples)**
- Ratio: 43,200 / 144 = 300:1 âś“âś“âś“ **VERY COMFORTABLE**
- Lasso can handle easily

Scenario B: **200 features, 1 week data (10,080 samples)**
- Ratio: 10,080 / 200 = 50:1 âś“âś“âś“ **VERY STABLE**
- Lasso can handle well

Scenario C: **250 features, 1 day data (1,440 samples)**
- Ratio: 1,440 / 250 = 5.76:1 âś“âś“ **ACCEPTABLE**
...
def lasso_feature_selection(
    ...
    Parameters:
      - X: Feature matrix (n_samples Ă— p_features)
      - y: Binary target
    ...
    print(f"âś“ Lasso Selection Complete")
    print(f"  Alpha: {best_alpha:.6f}")
    print(f"  CV AUC: {best_score:.4f} Â± {cv_scores.std():.4f}")
...
def lasso_with_preprocessing(X: pd.DataFrame, y: pd.Series) -> dict:
    ...
    print(f"\nâś“ Group-based Pre-filtering Complete:")
    for group, data in selected_by_group.items():
...
â”‚
â”śâ”€ FOLD 1: Train on folds 1-4 (80%), Validate on fold 5 (20%)
â”śâ”€ FOLD 2: Train on folds 1,3,4,5 (80%), Validate on fold 2 (20%)
â”śâ”€ FOLD 3: Train on folds 1,2,4,5 (80%), Validate on fold 3 (20%)
â”śâ”€ FOLD 4: Train on folds 1,2,3,5 (80%), Validate on fold 4 (20%)
â””â”€ FOLD 5: Train on folds 1,2,3,4 (80%), Validate on fold 5 (20%)
...
Outer Loop (5 folds): Evaluate final model performance
  â”‚
  â””â”€ Inner Loop (5 folds): Tune alpha parameter
        â”‚
        â””â”€ Test alpha values: 10^-4, 10^-3, ..., 10^1
```
...
**Rationale:**
1. âś“ **Sample size is EXCELLENT** (43,200+ samples for 200 features = 216:1 ratio)
2. âś“ **Lasso is robust** to high-dimensional data with proper regularization
3. âś“ **No pre-filtering needed** â€” sample size handles the full feature space
4. âś“ **Fully automated** â€” no manual correlation/VIF filtering required
5. âś“ **Optimal results** â€” Lasso finds globally best feature subset via CV
6. âś“ **Time efficient** â€” Faster than manual filtering workflow
7. âś“ **Reproducible** â€” Cross-validation ensures stable, generalizable features
...
## 14. Current Execution Task Breakdown

This is the current implementation plan. It supersedes the older correlation
matrix and VIF-based selection path. Correlation/VIF reports may still be useful
for diagnostics, but they are not part of the feature-selection decision.

### Task 1: Data Integrity First

**Goal:** Make the database safe to rebuild and sync repeatedly.

**Actions:**
- Review and fix the sync code path that creates duplicate rows.
- Keep OHLCV as the base table: one row per `open_time`.
- Make `sync_features()` idempotent:
  - use lookback rows only for rolling calculations,
  - insert only rows at or after the requested `start_time`,
  - skip `open_time` values that already exist in the FEATURES table.
- Make `sync_predictions()` idempotent:
  - collapse duplicate source feature rows before prediction,
  - skip `open_time` values that already exist in the PREDICTIONS table.
- Decide whether to deduplicate the current dev FEATURES/PREDICTIONS tables or rebuild them.
- Only after duplicate protection is in place, expand the FEATURES table with new columns.
- Add a lightweight validation script/report for duplicate `open_time` rows.

**Done when:**
- Re-running sync does not create duplicate feature rows.
- FEATURES and PREDICTIONS have one row per `open_time`.

**Current status:**
- Sync duplicate root cause fixed in `sync_features()`:
  - lookback rows are used only for rolling calculations,
  - only requested interval rows are inserted.
- `sync_predictions()` now collapses duplicate source feature rows and skips existing
  prediction `open_time` values.
- Dev derived tables rebuilt from OHLCV on 2026-05-23:
  - FEATURES rows: 3,406,708
  - PREDICTIONS rows: 3,406,708
  - duplicate `open_time` rows: 0 in both tables.

### Task 2: Define the Full Feature Universe

**Goal:** Store all candidate feature definitions in config before model work.

**Actions:**
- Expand `config/features.json` with the full potential feature set.
- Keep naming deterministic: `feat_<name>_<window>` where applicable.
- Group features by category: momentum, trend, volatility, volume, price action,
  market structure, and cross-feature derivatives.
- Do not manually pre-filter with correlation or VIF.

**Done when:**
- The feature config is the single source of truth for all candidate features.
- Every generated feature name is stable and reproducible.

### Task 3: Compute Candidate Features

**Goal:** Populate the database with all potential features.

**Actions:**
- Extend `src/data_pipeline/sync_features.py` to calculate the configured feature universe.
- Keep target columns unchanged:
  - `trg_l_rw_240_prc_09`
  - `trg_s_rw_240_prc_01`
- Rebuild or backfill the dev FEATURES table.
- Validate null rates, infinite values, and timestamp continuity.

**Done when:**
- The dev FEATURES table contains the complete candidate feature matrix.
- Feature generation is repeatable from the same OHLCV input.

### Task 4: Build LASSO CV Training Workflow

**Goal:** Create a reproducible training script/notebook for model selection.

**Actions:**
- Create separate training runs for LONG and SHORT targets.
- Use a pipeline: imputer -> scaler -> L1 logistic regression.
- Use walk-forward / purged time-series CV, not shuffled random folds.
- Use a purge gap of at least 240 minutes between train and validation blocks.
- Search `C` on a log grid, for example `np.logspace(3, -4, 50)`.
- Use `class_weight="balanced"` as the first baseline.
...
**Done when:**
- Each target has a CV result table by `C`.
- Each row includes PR-AUC, ROC-AUC, selected feature count, and fold stability.

### Task 5: Select Model Complexity

**Goal:** Pick the simplest model that performs near the best validation score.

**Actions:**
- Find the max mean PR-AUC.
- Prefer the smallest feature set within one standard error of the best score.
- Inspect selected feature stability across folds.
- Save selected feature lists separately for LONG and SHORT.

**Done when:**
- Final LONG and SHORT feature lists are selected.
- Chosen `C` values are documented with CV metrics.

### Task 6: Train Final Models

**Goal:** Produce deployable model artifacts.

**Actions:**
- Retrain LONG and SHORT models on the full training period using selected `C`.
- Save model, imputer, scaler, selected features, training window, and metrics.
- Update `config/models.json` to point to the new artifacts.
- Keep previous models available as fallback.

**Done when:**
- Final artifacts can be loaded by `sync_predictions()`.
- A prediction smoke test runs on recent feature rows.

### Task 7: Holdout Backtest

**Goal:** Validate the full signal workflow on untouched recent data.

**Actions:**
- Generate predictions for the holdout period.
- Compute spread: `long_p - short_p`.
- Re-estimate or validate LONG/SHORT cutoffs.
- Report signal count, precision, lift, return proxy, costs/slippage sensitivity,
  drawdown, and stability by market regime.

**Done when:**
- New LASSO models beat or clearly fail to beat the current baseline.
- Decision is made: deploy, tune further, or keep baseline.

### Task 8: Live Pipeline Integration

**Goal:** Use the selected LASSO models in the existing app.

**Actions:**
- Update prediction loading to support preprocessing artifacts.
- Ensure live feature columns exactly match selected training features.
- Keep errors explicit when a required feature is missing.
- Preserve the current GUI output contract.

**Done when:**
- `main_app.py` can run with the new models.
- Live predictions produce LONG/SHORT probabilities and spread signals.

### Task 9: Deploy and Monitor

**Goal:** Package and monitor the improved model safely.

**Actions:**
- Rebuild the PyInstaller app.
- Monitor live predictions, signal distribution, and data freshness.
- Compare live signal rates against holdout expectations.
- Keep rollback path to the current active models.

**Done when:**
- The packaged app runs with the new model configuration.
- Monitoring shows no feature drift, missing-column errors, or abnormal signal rates.
...
1. **Expand features** from 8 â†’ 35+ indicators across 7 categories
...
4. **No manual pre-filtering needed** â€” sample size (43,200+) is excellent for Lasso
