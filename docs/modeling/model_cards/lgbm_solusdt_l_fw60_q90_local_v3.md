# Model Card: `lgbm_solusdt_l_fw60_q90_local_v3`
...
Estimate whether a SOLUSDT 1-minute bar is followed by a strong upward
...
| Feature count | See `models/lgbm_solusdt_l_fw60_q90_local_v3/features.json` |
| Search artifacts | `models/lgbm_solusdt_l_fw60_q90_local_v3/search/` |
| Final artifacts | `models/lgbm_solusdt_l_fw60_q90_local_v3/` |
